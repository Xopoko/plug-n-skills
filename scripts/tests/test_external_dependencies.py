...
class ExternalDependenciesTest(unittest.TestCase):
    def setUp(self):
        ...
        (report_dir / "reverse-skill.md").write_text(
            "# reverse-skill audit\n\nPinned evidence.\n",
            encoding="utf-8",
        )
        self.receipt_path = report_dir / "reverse-skill.receipt.json"
            ...
            "dependencies": [
                {
                    ...
                    "audit": {
                        ...
                        "verdict": "isolate",
                        "report": "docs/external-dependencies/reverse-skill.md",
                        "receipt": (
                            "docs/external-dependencies/reverse-skill.receipt.json"
                        ),
                    },
                }
            ],
    ...
    def test_valid_actual_shape(self):
        ...
        self.assertEqual(payload["dependencies"][0]["id"], "reverse-skill")
    ...
    def test_report_is_distinct_nonblank_markdown_and_digest_bound(self):
        ...
        self.lock["dependencies"][0]["audit"]["receipt"] = (
            "docs/external-dependencies/reverse-skill.md"
        )
    ...
    def test_verify_sources_uses_exact_get_url_and_accepts_good_response(self):
        ...
        self.assertEqual(
            request.full_url,
            "https://api.github.com/repos/zhaoxuya520/reverse-skill/git/commits/"
            + "1" * 40,
        )
    ...
    def test_cli_validate_list_and_show(self):
        ...
        self.assertIn("reverse-skill", list_result.stdout)
        self.assertIn("zhaoxuya520/reverse-skill@", list_result.stdout)

        show_result = subprocess.run(
            [*common, "show", "reverse-skill"],
            text=True,
            stdout=subprocess.PIPE,
            stderr=subprocess.PIPE,
            check=False,
