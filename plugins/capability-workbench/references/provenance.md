...
| `plugin-creator` | Codex: `${CODEX_HOME:-$HOME/.codex}/skills/.system/plugin-creator`, Claude: `${CLAUDE_HOME:-$HOME/.claude}/skills/.system/plugin-creator` | plugin scaffold, manifest validation, marketplace entry rules, install/cache gate, separate runtime discovery, agent app handoff |
