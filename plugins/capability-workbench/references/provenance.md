...
| auxiliary skills | Codex: `${CODEX_HOME:-$HOME/.codex}/skills/optimize-skill-tokens`, `${CODEX_HOME:-$HOME/.codex}/skills/codex-token-lens`, `${CODEX_HOME:-$HOME/.codex}/skills/prompt-contract-first`; Claude: `${CLAUDE_HOME:-$HOME/.claude}/skills/optimize-skill-tokens`, `${CLAUDE_HOME:-$HOME/.claude}/skills/codex-token-lens`, `${CLAUDE_HOME:-$HOME/.claude}/skills/prompt-contract-first` | token-efficiency, context diagnostics, and schema-first prompt contract heuristics |
