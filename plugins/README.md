...
| `codex-cli` | `codex-cli@local` | `codex-cli@xopoko-plug-n-skills` | Codex CLI operations, exec/review automation, live thread supervision, controlled skill handoffs, doctor/debug/sandbox diagnostics, plugin and MCP lifecycle, normalized session trace audits, and local environment actions. |
