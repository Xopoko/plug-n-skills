...
| `codex-cli` | `codex-cli@local` | `codex-cli@xopoko-plug-n-skills` | Codex CLI operations, exec/review automation, doctor/debug/sandbox diagnostics, plugin and MCP lifecycle, normalized session trace audits, and local environment actions. |
