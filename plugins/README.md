...
| `i-have-adhd` | `i-have-adhd@local` | `i-have-adhd@xopoko-plug-n-skills` | Enable an explicit conversation-scoped focus mode with bounded steps, visible progress, concrete time, and one next action. |
...
| `design-intelligence` | `design-intelligence@local` | `design-intelligence@xopoko-plug-n-skills` | Frame and critique product/UX architecture, interaction, accessibility, visual communication, compact technical explanations, and design systems. |
