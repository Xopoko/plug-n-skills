...
| On-demand skill bodies | 166 skills | 116,917 | Instruction bodies after frontmatter, loaded only when selected. |
...
| `kotlin-multiplatform` | 14 | 19 | 1 | 1,124 | 12,626 |
...
| `kmp-gradle-doctor` | 81/1,781 | Diagnose and fix Kotlin Multiplatform Gradle, source-set, dependency, private dependency resolution or consumption failures, Android target, Compose plugin, KGP/AGP, testing, static-analysis, and CI issues. |
