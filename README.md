...
| On-demand skill bodies | 162 skills | 105,825 | Instruction bodies after frontmatter, loaded only when selected. |
...
| `kotlin-multiplatform` | 14 | 16 | 1 | 1,096 | 10,126 |
...
| `kmp-data-layer` | 71/714 | Design and review KMP data layers, repositories, source-of-truth, DTO/domain mapping, sync, offline-first behavior, persistence choices, error handling, threading, and API exposure. |
