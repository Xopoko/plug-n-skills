...
| Startup metadata | 165 skills | 13,089 | Skill name, description, and file pointer for routing. |
| On-demand skill bodies | 165 skills | 113,944 | Instruction bodies after frontmatter, loaded only when selected. |
