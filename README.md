...
| Startup metadata | 166 skills | 13,333 | Skill name, description, and file pointer for routing. |
| On-demand skill bodies | 166 skills | 119,064 | Instruction bodies after frontmatter, loaded only when selected. |
...
| `kotlin-multiplatform` | 14 | 22 | 2 | 1,135 | 14,436 |
...
| `kmp-testing-quality` | 76/2,352 | Design and review KMP testing strategy, commonTest, kotlin.test, platform tests, Compose Multiplatform UI tests, screenshot tests, test doubles, refactor safety, code review gates, and regression validation. |
