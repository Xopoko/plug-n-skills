...
| Startup metadata | 155 skills | 11,819 | Skill name, description, and file pointer for routing. |
| On-demand skill bodies | 155 skills | 99,478 | Instruction bodies after frontmatter, loaded only when selected. |
...
| `kmp-gradle-doctor` | 74/1,250 | Diagnose and fix Kotlin Multiplatform Gradle, source-set, dependency, Android target, Compose plugin, KGP/AGP, testing, static-analysis, and CI issues. |
